...
namespace QL_RapChieuPhim.Views
{
    public partial class Edit_Phim : Form
    {
        ...
        string[] strData;
        Database.ChoPhepKyTu cp = new Database.ChoPhepKyTu();
        ...
        private void txt_NamPhatHanh_KeyPress(object sender, KeyPressEventArgs e)
        {
            cp.KeyPress_DungKieuSo(sender, e);
        }

        private void txt_addDaodien_KeyPress(object sender, KeyPressEventArgs e)
        {
            cp.KeyPress_DungKieuChu(sender, e);
        }
    }
}
